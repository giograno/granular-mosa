...
public abstract class AbstractTestSuiteChromosome<T extends ExecutableChromosome> extends Chromosome {
	...
	/** distinction for BOOST between the two steps **/
	protected List<T> firstStepTests = new ArrayList<>();
	protected List<T> secondStepTests = new ArrayList<>();
	...
	/**
	 * Sets the suite generated by the first step of the algo
	 */
	public void addFirstStepSuite(List<T> suite) {
		firstStepTests = suite;
		this.addTests(suite);
	}

	/**
	 * Sets the suite generated by the second step of the algo
	 */
	public void addSecondStepSuite(List<T> suite) {
		secondStepTests = suite;
		this.addTests(suite);
	}

	/**
	 * Gets the suite generated by the first step of boost
	 */
	public List<T> getFirstStepTests() {
		return firstStepTests;
	}

	/**
	 * Gets the suite generated by the second step of boost
	 */
	public List<T> getSecondStepTests() {
		return secondStepTests;
	}
