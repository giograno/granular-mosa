...
public enum RuntimeVariable {
    ...
    Time2MaxCoverage,
    /** number of eager test in a suite */
    NoEagerTests, // post minimization
    Result_NoEagerTests, // pre minimization
    /**  Size of the suites generated by the first and the second step (it should be the same) only len changes */
    FirstStep_Size, // post minimization
    FirstStep_Result_Size, // pre minimization
    SecondStep_Size, // post minimization
    SecondStep_Result_Size, // pre minimization
    /**  Length of the suites generated by the first and the second step */
    FirstStep_Length, // post minimization
    FirstStep_Result_Length, // pre minimization
    ...
    SecondStep_NoEager, // post minimization
    SecondStep_Result_NoEager // pre minimization
    ;
    /* -------------------------------------------------- */
