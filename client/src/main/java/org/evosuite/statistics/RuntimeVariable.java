...
public enum RuntimeVariable {
	...
	NoEagerTest,
	/**  Size of the suites generated by the first and the second step */
	FirstStep_Size, // pre minimization
	FirstStep_Result_Size, // post minimization
	SecondStep_Size, // pre minimization
	SecondStep_Result_Size, // post minimization
	/**  Keep trace of the goals for each step */
	FirstStep_Goals,
	SecondStep_Goals,
	/** Number of eager tests in each step */
	FirstStep_NoEager, // pre minimization
	FirstStep_Result_NoEager, // post minimization
	SecondStep_NoEager, // pre minimization
	SecondStep_Result_NoEager, // post minimization
